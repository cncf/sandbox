...
The TOC will then vote on the project. The vote is a simple majority vote, and is timeboxed to three months from initial issue creation. If the project is accepted, the issue will be closed and the project will be moved to the [CNCF Sandbox](https://www.cncf.io/sandbox-projects/). If the project is rejected, the issue will be closed and the project will not be moved to the CNCF Sandbox. If the project is postponed, the issue will be closed and the project will not be moved to the CNCF Sandbox. The TOC will provide a comment on the issue that details the expectations in order for the project to be re-reviewed by the TOC. Depending on the status and details, there are a few options to be re-reviewed. For information on review ordering for postponed projects, plese refer to the [Review Order section](#review-order).
